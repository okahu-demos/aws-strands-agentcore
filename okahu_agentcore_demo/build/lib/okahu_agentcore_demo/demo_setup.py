...
TEST_PROMPT = "I want to book a flight from New York to San Francisco on 25th Dec 2026 and a hotel stay at San Francisco Hilton for 3 nights."
...
def run_agent_test():
    prompt:str = '{"prompt": "' + TEST_PROMPT + '}"}'
    sys.argv = ['agentcore', 'invoke', prompt]
    try:
        agentcore_main()
    except SystemExit as e:
        if e.code != 0:
